    ...
    public JDateChooser(JCalendar jcalendar, String dateFormatString, boolean startEmpty,
		...
		*/
        ...
        dateSpinner = new JSpinner(model) {
			 ...
			 * 
			 */
			private static final long serialVersionUID = 4247253783878526899L;
        ...
        if (icon == null) {
            try {
                icon = new ImageIcon(Thread.currentThread().getContextClassLoader().getResource(Constant.DATECHOOSER_ICON_PATH));
            } catch (Exception e) {
                icon = new ImageIcon();
            }
        }
        ...
        popup = new JPopupMenu() {
			 ...
			 * 
			 */
			private static final long serialVersionUID = 6394590918594731979L;
