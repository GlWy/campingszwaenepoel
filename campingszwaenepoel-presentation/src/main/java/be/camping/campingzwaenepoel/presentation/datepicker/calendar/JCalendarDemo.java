 ...
 */
package be.camping.campingzwaenepoel.presentation.datepicker.calendar;
...
import be.camping.campingzwaenepoel.presentation.datepicker.components.JLocaleChooser;
import be.camping.campingzwaenepoel.presentation.datepicker.components.JSpinField;
import be.camping.campingzwaenepoel.presentation.datepicker.components.JTitlePanel;
...
public class JCalendarDemo extends JApplet implements PropertyChangeListener {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 6060040209097094516L;
    ...
    class AboutAction extends AbstractAction {
		 ...
		 * 
		 */
		private static final long serialVersionUID = -7251502098814587153L;
